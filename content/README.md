...
2. `npm run sync:wikimedia` retains the original eight-item Chinese Wikipedia snapshot; `npm run expand:wikimedia` refreshes the remaining collection from the official English Wikipedia API.
...
6. Published collection entries stay within ACGN scope. The soundtrack channel is limited to official anime OSTs, game OSTs, or media-mix releases tied directly to ACGN works.
